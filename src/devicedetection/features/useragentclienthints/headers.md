...
# On-premise Pipeline API {#UACH_Headers_OnPrem}
...
## Integrated {#UACH_Http_Headers_Integrated}
...
## Non-integrated {#UACH_Http_Headers_NonIntegrated}
...
Accept-CH: sec-ch-ua,sec-ch-ua-mobile,sec-ch-ua-full-version-list,sec-ch-ua-platform,sec-ch-ua-platform-version,sec-ch-ua-model 
```
## Critical-CH {#UACH_Http_Headers_Critical}
...
## B2B Service Supplier {#UACH_Http_Headers_BtoB}
