...
|osv|Device operating system version (e.g., “3.1.2”).|[PlatformVersion](https://51degrees.com/developers/property-dictionary?item=OperatingSystem%7CName)|Indicates the version or subversion of the software platform.|
