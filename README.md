![51Degrees](https://51degrees.com/img/logo.png?utm_source=github&utm_medium=readme&utm_campaign=documentation&utm_content=readme.md&utm_term=top "Data rewards the curious") **Pipeline API Documentation**
...
**CSS Generation**: The custom CSS styling is generated by the [`pattern-library`](pattern-library/README.md) design system in this repository (a Storybook + Vite project; it replaced Pattern Lab). See its README for instructions on building and updating the CSS files.
...
| `pattern-library`   | Storybook + Vite design system that generates the custom CSS used in the generated documentation.            |
